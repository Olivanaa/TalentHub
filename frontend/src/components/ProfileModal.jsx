                    ...
                    <div className="pt-16 pb-8 px-8 max-h-[calc(90vh-180px)] overflow-y-auto">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-3">
                                            {profile.certificacoes.map((cert, index) => (
                                                <div
                                                    key={index}
                                                    className="bg-linear-to-r from-[#f83f32] to-[#F97316] rounded-xl p-4 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                                                >
                                                    <div className="flex items-center gap-2">
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                            <button
                                ...
                                className="bg-[#F97316] text-white font-semibold px-6 py-3 rounded-lg hover:bg-[#FB923C] transition-all duration-300 shadow-md"
                            >
                            ...
                            <button
                                ...
                                className="bg-[#f83f32] text-white font-semibold px-6 py-3 rounded-lg hover:bg-[#ff5d4a] transition-all duration-300 shadow-md"
                            >
                                Enviar Mensagem
                            </button>
                        </div>
